    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btAgendar.setOnClickListener {
            ...
            when{
                ...
                monitor1.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Wesley Lima", data, hora)

                }
                monitor2.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Maiara Cordeiro", data, hora)
                }
                monitor3.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
